...
urlpatterns = [
    ...
    path(
        "problems/suggest_list/",
        problem.SuggestList.as_view(),
        name="problem_suggest_list",
    ),
    path("problems/suggest", problem.ProblemSuggest.as_view(), name="problem_suggest"),
    path(
        "problem/<str:problem>",
        include(
            [
    ...
    path(
        ...
        include(
            [
                ...
                path(
                    "/download",
                    submission.SubmissionSourceDownload.as_view(),
    ...
    path(
        ...
        include(
            [
                ...
                path(
                    "/announce",
                    contests.ContestAnnounce.as_view(),
        ...
        include(
            [
                ...
                path(
                    "/<int:page>",
                    lambda request, page: HttpResponsePermanentRedirect(
                        "%s?page=%s" % (reverse("contributors_list"), page)
                    ),
                ),
                path(
                    "/find",
                    user.user_contributor_redirect,
    ...
    path(
        ...
        organization.CreateOrganization.as_view(),
        name="organization_create",
    ),
    path(
        "organization/<int:pk>-<slug:slug>",
        include(
            [
                path(
                    "",
                ...
                path(
                    "/problems",
                    organization.ProblemListOrganization.as_view(),
                    name="problem_list_organization",
                ),
                path(
                    "/contests",
                    organization.ContestListOrganization.as_view(),
                    name="contest_list_organization",
                ),
                path(
                    "/submissions/",
                    paged_list_view(
                        organization.SubmissionListOrganization,
                        "submission_list_organization",
                    ),
                ),
                path(
                    "/problem-create",
                    organization.ProblemCreateOrganization.as_view(),
                    name="problem_create_organization",
                ),
                path(
                    "/contest-create",
                    organization.ContestCreateOrganization.as_view(),
                ...
                path(
                    ...
                    include(
                        [
                            path(
                                "new",
                                organization.BlogPostCreateOrganization.as_view(),
    ...
    path(
        ...
        include(
            [
                path("", paged_list_view(blog.PostList, "blog_post_list")),
                path(
                    "<int:id>-<slug:slug>/",
                    include(
                        [
                ...
                path("downvote", blog.downvote_blog, name="blog_downvote"),
            ]
        ),
    ),
    ...
    path(
        ...
        include(
            [
                ...
                path(
                    "new", ticket.NewIssueTicketView.as_view(), name="new_issue_ticket"
                ),
            ]
        ),
    ),
    path(
        ...
        include(
            [
                ...
                path(
                    "/good",
                    ticket.TicketStatusChangeView.as_view(contributive=True),
                    name="ticket_good",
                ),
                path(
                    "/norm",
                    ticket.TicketStatusChangeView.as_view(contributive=False),
                    name="ticket_norm",
                ),
                path(
    ...
    path('problems/random/', problem.RandomProblem.as_view(), name='problem_random'),
    path('problems/create', problem.ProblemCreate.as_view(), name='problem_create'),
    path('problems/suggest_list/', problem.SuggestList.as_view(), name='problem_suggest_list'),
    path('problems/suggest', problem.ProblemSuggest.as_view(), name='problem_suggest'),
    ...
    path('contests/new/', contests.CreateContest.as_view(), name='contest_new'),
    re_path('contests/tag/(?P<name>[a-z-]+)', include([
        path('', contests.ContestTagDetail.as_view(), name='contest_tag'),
