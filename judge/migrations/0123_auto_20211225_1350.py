    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.FloatField(
                help_text="Points awarded for problem completion. Points are displayed with a 'p' suffix if partial. 1-1.5: beginner problems; 1.5-2: simple algorithm                                             (binary search, sieve, etc.); 2-3: advanced algorithm                                             (dp, dijkstra, dsu, etc.); 2.5-3.5: 1st probs of VOI; 3.5-4.5: 2nd probs of                                             VOI; 4.5-6: 3rd prob of VOI.",
